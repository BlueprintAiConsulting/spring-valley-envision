...
export const ROOFING_OPTIONS: RoofingLine[] = [
  {
    ...
    colors: [
      { id: 'lm-moire-black',      name: 'Moire Black',        hex: '#22252A', hue: 'Deep classic black-charcoal',          swatchImage: asset('/textures/roofing/moire-black.jpg') },
      { id: 'lm-pewterwood',       name: 'Max Def Pewterwood', hex: '#4A4D4A', hue: 'Cool slate-gray blend',              swatchImage: asset('/textures/roofing/pewterwood.jpg') },
      { id: 'lm-weathered-wood',   name: 'Weathered Wood',     hex: '#635C52', hue: 'Natural weathered cedar brown-gray', swatchImage: asset('/textures/roofing/weathered-wood.jpg') },
      { id: 'lm-colonial-slate',   name: 'Colonial Slate',     hex: '#565D68', hue: 'Cool blue-slate blend',               swatchImage: asset('/textures/roofing/colonial-slate.jpg') },
      { id: 'lm-burnt-sienna',     name: 'Burnt Sienna',       hex: '#6E4E3A', hue: 'Warm rich reddish-brown',            swatchImage: asset('/textures/roofing/burnt-sienna.jpg') },
      { id: 'lm-cobblestone-gray', name: 'Cobblestone Gray',   hex: '#7E8184', hue: 'Medium warm neutral gray',           swatchImage: asset('/textures/roofing/cobblestone-gray.jpg') },
      { id: 'lm-georgetown-gray',  name: 'Georgetown Gray',    hex: '#6C7075', hue: 'Classic slate gray',                  swatchImage: asset('/textures/roofing/georgetown-gray.jpg') },
      { id: 'lm-heather-blend',    name: 'Heather Blend',      hex: '#75604C', hue: 'Warm earthy brown mix',              swatchImage: asset('/textures/roofing/heather-blend.jpg') },
      { id: 'lm-driftwood',        name: 'Driftwood',          hex: '#857C70', hue: 'Silvery weathered gray-brown',         swatchImage: asset('/textures/roofing/driftwood.jpg') },
      { id: 'lm-charcoal-black',   name: 'Charcoal Black',     hex: '#1F2124', hue: 'Deep uniform dark charcoal',          swatchImage: asset('/textures/roofing/charcoal-black.jpg') },
      { id: 'lm-resawn-shake',     name: 'Resawn Shake',       hex: '#8C7355', hue: 'Warm rustic cedar shake',            swatchImage: asset('/textures/roofing/resawn-shake.jpg') },
      { id: 'lm-hunter-green',     name: 'Hunter Green',       hex: '#36473A', hue: 'Deep forest evergreen',              swatchImage: asset('/textures/roofing/hunter-green.jpg') },
      { id: 'lm-shenandoah',       name: 'Shenandoah',         hex: '#5E6457', hue: 'Earthy moss green-gray',              swatchImage: asset('/textures/roofing/shenandoah.jpg') },
      { id: 'lm-silver-birch',     name: 'Silver Birch',       hex: '#BBB8B0', hue: 'Light reflective gray-white',         swatchImage: asset('/textures/roofing/silver-birch.jpg') },
    ]
  },
  {
    tier: 'Landmark® PRO',
    ...
    colors: [
      { id: 'pro-moire-black',      name: 'Max Def Moire Black',      hex: '#22252A', hue: 'Deep high-definition rich black',     swatchImage: asset('/textures/roofing/moire-black.jpg') },
      { id: 'pro-pewterwood',       name: 'Max Def Pewterwood',       hex: '#4A4D4A', hue: 'Rich high-contrast pewter gray',      swatchImage: asset('/textures/roofing/pewterwood.jpg') },
      { id: 'pro-weathered-wood',   name: 'Max Def Weathered Wood',   hex: '#635C52', hue: 'High-contrast aged wood blend',        swatchImage: asset('/textures/roofing/weathered-wood.jpg') },
      { id: 'pro-georgetown-gray',  name: 'Max Def Georgetown Gray',  hex: '#6C7075', hue: 'Bold dramatic slate gray',             swatchImage: asset('/textures/roofing/georgetown-gray.jpg') },
      { id: 'pro-heather-blend',    name: 'Max Def Heather Blend',    hex: '#75604C', hue: 'Deep rich heather earth tone',        swatchImage: asset('/textures/roofing/heather-blend.jpg') },
      { id: 'pro-burnt-sienna',     name: 'Max Def Burnt Sienna',     hex: '#6E4E3A', hue: 'Vibrant autumn cedar red-brown',      swatchImage: asset('/textures/roofing/burnt-sienna.jpg') },
      { id: 'pro-cobblestone-gray', name: 'Max Def Cobblestone Gray', hex: '#7E8184', hue: 'Dimensional light stone gray',         swatchImage: asset('/textures/roofing/cobblestone-gray.jpg') },
      { id: 'pro-colonial-slate',   name: 'Max Def Colonial Slate',   hex: '#565D68', hue: 'High-contrast colonial blue-gray',    swatchImage: asset('/textures/roofing/colonial-slate.jpg') },
      { id: 'pro-resawn-shake',     name: 'Max Def Resawn Shake',     hex: '#8C7355', hue: 'Deep multidimensional rustic cedar',  swatchImage: asset('/textures/roofing/resawn-shake.jpg') },
      { id: 'pro-driftwood',        name: 'Max Def Driftwood',        hex: '#857C70', hue: 'Dynamic aged driftwood blend',        swatchImage: asset('/textures/roofing/driftwood.jpg') },
      { id: 'pro-shenandoah',       name: 'Max Def Shenandoah',       hex: '#5E6457', hue: 'Rich dimensional woodland gray-green', swatchImage: asset('/textures/roofing/shenandoah.jpg') },
    ]
  }
];
